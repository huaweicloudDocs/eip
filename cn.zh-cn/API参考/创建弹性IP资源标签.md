...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=EIP&api=CreatePublicipTag)中调试该接口。
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>EIP唯一标识</p>
</td>
</tr>
</tbody>
</table>
...
<a name="request_CreatePublicipTagRequestBody"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p><a href="#request_ResourceTagOption">ResourceTagOption</a> object</p>
</td>
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>tag对象</p>
</td>
</tr>
</tbody>
</table>
...
<a name="request_ResourceTagOption"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><ul><li><p>标签名称。</p>
</li><li><p>不能为空。</p>
</li><li><p>长度不超过36个字符。</p>
</li><li><p>由英文字母、数字、下划线、中划线、中文字符组成</p>
</li><li><p>同一资源的key值不能重复。</p>
</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><ul><li><p>标签值</p>
