# 删除弹性IP的标签<a name="eip_apitag_0003"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=EIP&api=DeletePublicipTag)中调试该接口。
