...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=EIP&api=ShowPublicip)中调试该接口。
...
<a name="response_ShowPublicipResponseBody"></a>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p><a href="#response_PublicipShowResp">PublicipShowResp</a> object</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>EIP对象</p>
</td>
</tr>
</tbody>
</table>
